...
2. Insert the button labels using `textline elements`. You may either use a constant string or an OpenSesame [variable](http://osdoc.cogsci.nl/usage/variables-and-conditional-statements/) (e.g., '[CategoryLeft]').
